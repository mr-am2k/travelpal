      ...
      >
        ...
        <div className="flex flex-col gap-3 mt-auto h-[405px]">
          <div className="flex flex-col text-center gap-2">
            <h3 className="text-[16px] sm:text-[24px] font-bold leading-[29px]">
              {fullName}
            </h3>
            <p className="text-[16px] sm:text-[24px] font-light">Traveler</p>
          </div>
          {/* DESCRIPTION */}
          <p className="text-[16px] sm:text-[24px] font-thin leading-[29px] text-center mt-6 max-w-[500px] px-[5px] mx-auto">
            {description}
          </p>
          {/* READ MORE */}
          <p className="text-[#1477ff] text-[16px] sm:text-[24px] font-normal leading-[29px] text-center mt-auto mb-14">
            read more...
          </p>
        </div>
      </div>
